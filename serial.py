...
def main():
    ...
    results_testset, results_fullset = random_forest(X_train, X_test, y_train, y_test, X, y)

    print("Starting decision trees...\n")
    results_testset, results_fullset = decision_trees(X_train, X_test, y_train, y_test, X, y,results_testset, results_fullset)

    print("starting neural_networks...\n")
    results_testset, results_fullset = neural_networs(X_train, X_test, y_train, y_test, X, y,results_testset, results_fullset)
